...
public class NewProjectPage extends BaseView {
    ...
    @Step("Добавление контактного лица")
    ...
    @Step("Добавление куратора проекта")
    ...
    @Step("Добавление руководителя проекта")
    ...
    @Step("Добавление администратора проекта")
